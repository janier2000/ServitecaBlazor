...
namespace Serviteca.Backend.Controllers
{
    ...
    public class BrandController  : GenericController<VehicleBrand>
    {
        private readonly IVehicleBrandRepository _brandRepository;
        public BrandController(IGenericUnitOfWork<VehicleBrand> unitOfWork, IVehicleBrandRepository brandRepository) : base(unitOfWork)
        {
