...
namespace Serviteca.Backend.Controllers
{
    ...
    public class VehUseController : GenericController<VehicleUse>
    {
        private readonly IVehicleUseRepository _vehicleUseRepository;
        public VehUseController(IGenericUnitOfWork<VehicleUse> unitOfWork, IVehicleUseRepository vehicleUseRepository) : base(unitOfWork)
        {
