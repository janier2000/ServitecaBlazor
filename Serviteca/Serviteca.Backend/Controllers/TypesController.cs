...
public class TypesController : GenericController<TypeV>
{
    private readonly ITypesRepository _vehicleTypeRepository;

    public TypesController(IGenericUnitOfWork<TypeV> unitOfWork, ITypesRepository vehicleTypeRepository) : base(unitOfWork)
    {
