...
public class VehicleBrandsController : GenericController<VehicleBrand>
{
    private readonly IVehicleBrandsRepository _brandRepository;

    public VehicleBrandsController(IGenericUnitOfWork<VehicleBrand> unitOfWork, IVehicleBrandsRepository brandRepository) : base(unitOfWork)
    {
