...
namespace Serviteca.Backend.Migrations
{
    ...
    [Migration("20260528204228_AddEntity800")]
    partial class AddEntity800
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Serviteca.Shared.Entities.Vehicle", b =>
                {
                    ...
                    b.HasOne("Serviteca.Shared.Entities.Brand", "VehicleBrand")
                        .WithMany("Vehicle")
                        .HasForeignKey("VehicleBrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Serviteca.Shared.Entities.Use", "VehicleUse")
                        .WithMany("Vehicle")
